...
import { Mail, Instagram, ArrowUpRight, MapPin, Send } from 'lucide-react';
...
const Contact: React.FC = () => {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      ...
      if (data) {
        ...
        setContactInfo({
          whatsapp: parsed.phone || '829-580-7411',
          instagram: parsed.instagram_url || '@raynolddesignsrl',
          email: parsed.email || 'cotizaciones@raynolddesignssrl.com',
          domain: 'raynolddesignssrl.com',
          address: parsed.location || 'Punta Cana, República Dominicana'
        });
      }
    };
    fetchSettings();
  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-b from-raynold-black to-gray-900 relative">
